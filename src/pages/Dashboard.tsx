  ...
  return (
    <div className="flex-1 overflow-auto flex flex-col p-4 md:p-6 animate-in slide-in-from-bottom-2 duration-500 fade-in">
      <div className="flex flex-col gap-1 mb-4 md:mb-6">
        <h2 className="text-xl font-semibold tracking-tight text-zinc-900 dark:text-white">{t('dashboard')}</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 shrink-0 mb-6">
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-4 rounded-xl">
          <p className="text-xs text-zinc-500 dark:text-zinc-400 uppercase font-medium mb-1">{t('totalAssigned')}</p>
          <div className="flex justify-between items-end">
            <h3 className="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">{stats.total}</h3>
            <Boxes className="w-5 h-5 text-zinc-600 mb-1" />
          </div>
        </div>

        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-4 rounded-xl">
          <p className="text-xs text-zinc-500 dark:text-zinc-400 uppercase font-medium mb-1">{t('liveAccounts')}</p>
          <div className="flex justify-between items-end">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-4 rounded-xl">
          <p className="text-xs text-zinc-500 dark:text-zinc-400 uppercase font-medium mb-1">{t('disabledAccs')}</p>
          <div className="flex justify-between items-end">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-4 rounded-xl">
          <p className="text-xs text-zinc-500 dark:text-zinc-400 uppercase font-medium mb-1">{t('outOfStockItems')}</p>
          <div className="flex justify-between items-end">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-[300px]">
        <div className="lg:col-span-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-4 rounded-xl flex flex-col shadow-xl">
          <h3 className="text-xs text-zinc-500 dark:text-zinc-400 uppercase font-bold tracking-wider mb-4">{t('accountStatusDist')}</h3>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-4 rounded-xl flex flex-col shadow-xl">
          <h3 className="text-xs text-zinc-500 dark:text-zinc-400 uppercase font-bold tracking-wider mb-4">{t('accountTypeSplit')}</h3>
